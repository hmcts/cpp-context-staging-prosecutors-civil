...
import static uk.gov.moj.cpp.staging.civil.processor.utils.Prosecutors.otherCaseCaseDetail;
import static uk.gov.moj.cpp.staging.civil.processor.utils.Prosecutors.ENFORCEMENT_RELATED_REFERENCE_NUMBER;
...
public class ProsecutionCaseToGroupProsecutionConverterForOthersTest {
    ...
    public void shouldConvertProsecutionToProsecutionCaseFile() {
        ...
        final ProsecutionCase prosecutionCase = otherCaseCaseDetail();
    ...
    public void shouldMapRelatedReferenceNumberToRelatedUrnForEnforcementCase() {
        ...
        assertThat(result.getCaseDetails().getRelatedUrn(), is(ENFORCEMENT_RELATED_REFERENCE_NUMBER));
    }
}