...
public class DefendantToProsecutionCaseFileDefendantConverterTest {
    ...
    public void shouldConvertProsecutionDefendantToProsecutionCaseFileDefendant() {
        ...
        final Converter<Defendant, uk.gov.moj.cpp.prosecution.casefile.json.schemas.Defendant> converter
                = new DefendantToProsecutionCaseFileDefendantConverter(othersProsecutionReceived.getHearingDetails(), null);
        ...
        assertProsecutionCaseFileDefendantMatchesProsecutionDefendant(prosecutionCaseFileDefendant, prosecutorsDefendant, othersProsecutionReceived);
    }
    ...
    private static void assertProsecutionCaseFileDefendantMatchesProsecutionDefendant(final uk.gov.moj.cpp.prosecution.casefile.json.schemas.Defendant prosecutionCaseFileDefendant,
                                                                                      final Defendant prosecutorsDefendant, final OthersProsecutionReceived othersProsecutionReceived) {
        ...
        assertHearingDetails(prosecutionCaseFileDefendant.getInitialHearing(), othersProsecutionReceived.getHearingDetails());
