...
public class ProsecutionCaseToGroupProsecutionConverterForEnforcement implements Converter<ProsecutionCase, GroupProsecutions> {

    private static final String INITIATION_CODE_CIVIL_CASE = "O";
    private final ZonedDateTime dateReceived;
    private final EnforcementProsecutionReceived enforcementProsecutionReceived;
    private UUID groupId;
    private Map<String, UUID> caseRefToCaseId;

    public ProsecutionCaseToGroupProsecutionConverterForEnforcement(final ZonedDateTime dateReceived, final EnforcementProsecutionReceived enforcementProsecutionReceived, final UUID groupId, final Map<String, UUID> caseRefToCaseId) {
        this.dateReceived = dateReceived;
        this.enforcementProsecutionReceived = enforcementProsecutionReceived;
    ...
    public GroupProsecutions convert(final ProsecutionCase prosecutionCase) {
        ...
        final Converter<Defendant, uk.gov.moj.cpp.prosecution.casefile.json.schemas.Defendant> defendantToProsecutionCaseFileDefendantConverter
                = new DefendantToProsecutionCaseFileDefendantConverter(enforcementProsecutionReceived.getHearingDetails());
    ...
    private CaseDetails buildCaseDetails(final ProsecutionCase prosecutionCase) {
        ...
        final UUID caseFileId = caseRefToCaseId.get(getProsecutorCaseReference(enforcementProsecutionReceived.getProsecutingAuthority(), prosecutionCase.getUrn()));
        ...
        return CaseDetails.caseDetails()
                ...
                .withOriginatingOrganisation(enforcementProsecutionReceived.getProsecutingAuthority())
                ...
                .withProsecutor(Prosecutor.prosecutor()
                        ...
                        .withProsecutingAuthority(enforcementProsecutionReceived.getProsecutingAuthority()).build())
                .build();
    }
