...
public class SubmitSummonsIT {
    ...
    public void shouldUpdateStatusToSuccessWithWarningsForSummonsProsecution() {
        UrlResponse urlResponse = StagingProsecutorsCivilUtils.submitOtherCase("payload/summons/stagingcivil.submit-summons-prosecution-all-fields.json", SUMMONS_CONTENT_TYPE);
        final UUID submissionId = urlResponse.getSubmissionId();
    ...
    public void shouldSubmitSummonsProsecutionWithRelatedReferenceNumber() {
        final String payload = "payload/summons/stagingcivil.submit-summons-prosecution-with-related-reference.json";
